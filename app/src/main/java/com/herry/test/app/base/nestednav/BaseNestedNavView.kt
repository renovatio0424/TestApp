...
@Suppress("unused")
abstract class BaseNestedNavView<V: MVPView<P>, P: MVPPresenter<V>>: BaseNestedNavFragment(), MVPView<P>, MVPViewCreation<V, P> {
    ...
    override fun onTransitionStart() {
        ...
        if(presenter is BaseNestedNavPresent<*>) {
            (presenter as BaseNestedNavPresent<*>).navTransitionStart()
        }
    }
    ...
    override fun onTransitionEnd() {
        ...
        if(presenter is BaseNestedNavPresent<*>) {
            (presenter as BaseNestedNavPresent<*>).navTransitionEnd()
        }
    }

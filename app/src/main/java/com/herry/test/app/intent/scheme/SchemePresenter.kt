...
//        setTestItems()
    ...
    private fun load() {
        val testSchemes: MutableList<SchemeContract.SchemaData> = mutableListOf(
            ...
            SchemeContract.SchemaData("Subscription  with  sku ID", "kinemaster://kinemaster/subscribe?sku_monthly=2&sku_annual=3", "https://kinema.link/page/1B33"),
            ...
            SchemeContract.SchemaData("Detail Project Feed ", "kinemaster://kinemaster/projectfeed/[FeedID]", "https://kinema.link/page/w8m1"),
